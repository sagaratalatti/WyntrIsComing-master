package io.wyntr.peepster.video;
...
finalUri=getoutputmediauri(cacheFile);
        if (Build.VERSION.SDK_INT < 18 && (resultHeight > resultWidth && resultWidth != originalWidth && resultHeight != originalHeight) || (landResultWidth > landResultHeight && landResultWidth != originalWidth && landResultHeight != originalHeight)) {
